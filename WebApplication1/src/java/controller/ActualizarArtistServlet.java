 ...
 * @author Chelo
 */
@WebServlet(name = "ActualizarArtistServlet", urlPatterns = {"/actualizar.do"})
public class ActualizarArtistServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            a.setId(Integer.parseInt(request.getParameter("artist_id")));
